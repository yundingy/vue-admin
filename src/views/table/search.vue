  ...
  <div class="search-list-vue frame-page h-panel">
    ...
    <div class="h-panel-bar">
      <div style="padding: 0px 0 20px;">
        <Search :width="400" v-model="params.keyword" @search="getData(true)" showSearchButton></Search>
      </div>
...
<script>
  ...
  export default {
    data() {
      return {
        dicts: {
          type: [{ key: 1, title: '类型一' }, { key: 2, title: '类型二' }, { key: 3, title: '类型三' }, {
            key: 4,
            title: '类型四'
          }, { key: 5, title: '类型五' }],
          location: [{ key: '001', title: '上海' }, { key: '002', title: '杭州' }, {
            key: '003',
            title: '北京'
          }, { key: '004', title: '广州' }, { key: '005', title: '深圳' }],
          salary: [{ key: '10', title: '10万以下', max: 10, min: 0 }, {
            key: '20',
            title: '10-20万',
            max: 20,
            min: 10
            ...
            max: 40,
            min: 30
          }, { key: '50', title: '50-100万', max: 100, min: 50 }, { key: '100', title: '100万以上', max: null, min: 100 }],
          year: [{ key: '1', title: '1年以下', max: 1, min: 0 }, { key: '3', title: '1-3年', max: 3, min: 1 }, {
            key: '5',
            title: '3-5年',
            max: 5,
            min: 3
          }, { key: '10', title: '5-10年', max: 10, min: 5 }, { key: '100', title: '10年以上', max: 100, min: 10 }]
        },
        pagination: {
          page: 1,
          size: 20,
