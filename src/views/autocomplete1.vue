  ...
  <div class="frame-page autocomplete-baidu h-panel">
    ...
    <div class="middle-container">
      <div class="search-container">
        <AutoComplete class="flex1" :showDropdownWhenNoResult="false" placeholder=" " :mustMatch="false" config="baidu"
                      v-model="keyword" type="title" @change="trigger"></AutoComplete>
